  ...
  return (
    ...
    >
        ...
        >
            ...
            {/* Company Info */}
            <motion.div className='max-w-sm flex-1'>
                <motion.div 
                    whileHover={{ scale: 1.05 }}
                    className='flex items-center gap-2 mb-4'
                >
                    <img src={assets.logo} alt="logo" className='h-8 md:h-9' />
                    <span className='font-bold text-lg bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent'>CarRent</span>
                </motion.div>
                ...
                <div className='flex items-center gap-4'>
                    {[
                        ...
                        <motion.a 
                            key={idx}
                            href="#" 
                            className={`p-2.5 rounded-lg bg-gray-100 hover:bg-gray-200 transition-all ${social.hover}`}
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.95 }}
                        >
                            <img src={social.icon} className='w-5 h-5' alt={social.label} title={social.label}/>
                        </motion.a>
                    ))}
                </div>
            </motion.div>
            ...
            >
                ...
                <div>
                    ...
                    <ul className='space-y-3'>
                        ...
                        <li><Link to="/cars" className='text-gray-700 hover:text-blue-600 transition-colors'>Browse Cars</Link></li>
                        <li><a href="#" className='text-gray-700 hover:text-blue-600 transition-colors'>List Your Car</a></li>
                ...
                <div>
                    ...
                    <ul className='space-y-3'>
                        ...
                        <li><a href="#" className='text-gray-700 hover:text-blue-600 transition-colors'>FAQs</a></li>
                        <li><a href="#" className='text-gray-700 hover:text-blue-600 transition-colors'>Insurance</a></li>
                        <li><a href="#" className='text-gray-700 hover:text-blue-600 transition-colors'>Blog</a></li>
                    </ul>
                </div>
        ...
        <motion.div 
            ...
            viewport={{ once: true }}
            className='border-t border-gray-200 py-8 flex flex-col md:flex-row items-center justify-between gap-4'
        >
            <p className='text-gray-600 text-sm'>© {new Date().getFullYear()} CarRent. All rights reserved.</p>
